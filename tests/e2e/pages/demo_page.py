...
class DemoPage:
    ...
    def open(self) -> None:
        self.page.goto(DEMO_PAGE_URL)

    def login(self, username: str = "tester", password: str = "secret") -> None:
        self.page.locator('[data-testid="username"]', description="用户名输入框").fill(username)
        self.page.locator('[data-testid="password"]', description="密码输入框").fill(password)
